...
;// CONCATENATED MODULE: ./src/util/nav.ts
function highlightLink(active,toCheck,breadcrumps){if(active.slice(-1)=="/")active.slice(0,-1);active.replace("//","/");if(toCheck.slice(-1)=="/")toCheck.slice(0,-1);toCheck.replace("//","/");const activeArr=active.split("/");const toCheckArr=toCheck.split("/");const bcArr=breadcrumps.map(bc=>bc.href);if(active.toLowerCase()==toCheck.toLowerCase())return true;if(active.includes("/category/")){for(const bc of bcArr){if(bc.toLowerCase()==toCheck.toLowerCase()){return true;}}}for(let i=0;i<activeArr.length;i++){if(activeArr.slice(0,i+1).join("/").toLowerCase()==toCheck.toLowerCase()){return true;}if(("/docs/category/"+activeArr[i]).toLowerCase()==toCheck.toLowerCase()){return true;}}return false;}
;// CONCATENATED MODULE: ./src/components/nav/NavbarItem.tsx
const NavbarItem=props=>{const theme=(0,MantineProvider/* useMantineTheme */.rZ)();const breadcrumbs=(0,docsUtils/* useSidebarBreadcrumbs */.s1)();const bcLinks=breadcrumbs.map(bc=>bc.href);return/*#__PURE__*/react.createElement(Accordion/* Accordion */.U,{multiple:true,defaultValue:[window.location.pathname.split("/").slice(0,props.depth+1).join("/")+(props.depth>=3?"/":""),bcLinks[props.depth-2]]},props.items.map(element=>/*#__PURE__*/react.createElement(Accordion/* Accordion.Item */.U.Item,{value:element.href,style:{border:"none"},key:element.href},/*#__PURE__*/react.createElement(Accordion/* Accordion.Control */.U.Control,{chevron:element.type=="link"&&"ㅤ",style:{backgroundColor:highlightLink(window.location.pathname,element.href,breadcrumbs)?theme.colorScheme=="dark"?theme.colors.dark[5]:theme.colors.gray[1]:undefined},onClick:e=>element.type=="link"?window.location.href=element.href:undefined},/*#__PURE__*/react.createElement("div",{onClick:e=>window.location.href=element.href},element.label)),element.type!="link"&&/*#__PURE__*/react.createElement(Accordion/* Accordion.Panel */.U.Panel,null,/*#__PURE__*/react.createElement(NavbarItem,(0,esm_extends/* default */.Z)({},element,{depth:props.depth+1}))))));};/* harmony default export */ const nav_NavbarItem = (NavbarItem);
;// CONCATENATED MODULE: ./src/components/nav/NavbarRoot.tsx
const NavbarRoot=props=>{const breadcrumbs=(0,docsUtils/* useSidebarBreadcrumbs */.s1)();const bcLinks=breadcrumbs.map(bc=>bc.href);const theme=(0,MantineProvider/* useMantineTheme */.rZ)();return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(Center/* Center */.M,null,/*#__PURE__*/react.createElement(Group/* Group */.Z,{spacing:5,onClick:()=>window.location.href="/",style:{height:60,fontFamily:"Minecraft",fontSize:"20px",position:"relative",top:"2px",cursor:"pointer",userSelect:"none",WebkitUserSelect:"none"}},/*#__PURE__*/react.createElement("img",{src:"/logo.png",alt:"BuildTheEarth",height:"40",style:{marginRight:"4px",position:"relative",top:"-2px"}}),"BuildTheEarth")),/*#__PURE__*/react.createElement(Accordion/* Accordion */.U,{defaultValue:[window.location.pathname.includes("/category/")?bcLinks[0]:"/docs/category/"+window.location.pathname.split("/")[2]],multiple:true},props.sidebar.map(element=>/*#__PURE__*/react.createElement(Accordion/* Accordion.Item */.U.Item,{value:element.href,style:{border:"none"},key:element.href},/*#__PURE__*/react.createElement(Accordion/* Accordion.Control */.U.Control,{chevron:element.type=="link"&&"ㅤ",style:{backgroundColor:highlightLink(window.location.pathname,element.href,breadcrumbs)?theme.colorScheme=="dark"?theme.colors.dark[5]:theme.colors.gray[1]:undefined}},/*#__PURE__*/react.createElement("div",{onClick:e=>window.location.href=element.href},element.label)),element.type!="link"&&/*#__PURE__*/react.createElement(Accordion/* Accordion.Panel */.U.Panel,null,/*#__PURE__*/react.createElement(nav_NavbarItem,(0,esm_extends/* default */.Z)({},element,{depth:3})))))));};/* harmony default export */ const nav_NavbarRoot = (NavbarRoot);
