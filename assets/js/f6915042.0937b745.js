...
Dont forget to save your settings!`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h1",{"id":"reviewing"},`Reviewing`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`Some changes have been made to the review process on the new website. This includes the removal of the "claimed" state of applications. Multiple people can review one application at the same time without blocking each other. You can also change the review status of an application after the initial status change.
Note that this will also remove the users builder's role on discord.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("admonition",{"title":"Reasons","type":"note"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",{parentName:"admonition"},`You can still enter a rejection reason for applications, the form will appear when you press the reject button`)),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h1",{"id":"showcase-images"},`Showcase Images`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`You can upload images of built places to be showcased on the Gallery and Main page of the Website. These images will rotate randomly every 2 minutes.
If you want to add an image, please input the name of the location in the format of `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`[Building], [City]`),` (Or only `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`[City]`),`) . The Date should be the Date of Construction, not your uploading date.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h1",{"id":"api"},`API`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`The new website now supports an API. Documentation can be found at `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a",{parentName:"p","href":"https://buildtheearth.github.io/website-node-backend/"},`https://buildtheearth.github.io/website-node-backend/`),`. There are three components of the API:`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("img",{alt:"API Overview",src:(__webpack_require__(9637)/* ["default"] */ .Z),width:"1600",height:"763"})),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("ol",null,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li",{parentName:"ol"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong",{parentName:"li"},`Public API:`),` Data that can be accessed without needing to sign in or providing a token. For example `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a",{parentName:"li","href":"https://api.buildtheearth.net/api/v1/buildteams"},`/api/v1/buildteams`),` or `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a",{parentName:"li","href":"https://api.buildtheearth.net/api/v1/faq"},`/api/v1/faq`)),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li",{parentName:"ol"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong",{parentName:"li"},`Private API:`),` All routes in this part of the API are only accessable with a valid access_token from Keycloak and the correct `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a",{parentName:"li","href":"#permissions"},`permissions`),`. This is so only registered users can manipulate data.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li",{parentName:"ol"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong",{parentName:"li"},`Teams API:`),` These routes can be accessed with your BuildTeam Token and work the same way as Private Routes, but only for your BuildTeam. They dont require additional permissions. Use these for integration into your website or other systems.`)));};MDXContent.isMDXComponent=true;
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/api-78839e60266eb34cd1c4dc2426e062a5.png");
